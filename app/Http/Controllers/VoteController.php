...
class VoteController extends Controller
{
    ...
    public function process(Request $request)
    {
        ...
        $outVerified = false;
            ...
            $actualOUT = $this->getOuts((int)file_get_contents(base_path() . "/vote"));
    ...
    public function object($item = 1)
    {
        ...
        {
            $json = [
                'name'        => 'Ticket de loterie doré (loterie en MAINTENANCE)',
        ...
        {
            $json = [
                'name'        => 'Ticket de loterie (loterie en MAINTENANCE)',
