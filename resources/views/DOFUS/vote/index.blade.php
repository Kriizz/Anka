            ...
            <div class="col-sm-6">
                <div class="row">
                    <div class="ak-block-gift-win">
                        ...
                        <div class="ak-gift-win"><span>Tickets gagnés (loterie en MAINTENANCE) </span> {{ $giftsCount }}</div>
                    </div>
                    <div class="ak-block-next-gift">
                        <div class="ak-gift"><img src="{{ URL::asset('imgs/lottery/ticket_gold.png') }}" alt="gift"></div>
                        <div class="ak-next-gift"><span>Prochain ticket (loterie en MAINTENANCE)</span> dans {{ $nextGifts }} votes</div>
                    </div>
                </div>
            </div>
        </div>
