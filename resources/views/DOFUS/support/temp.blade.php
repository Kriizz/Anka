        ...
        <div class="ak-container ak-panel ak-glue">
            <div class="ak-panel-content">
                <div class="panel-main">
                    ...
                    @else
                     <div class="">
                    <a href="{{ URL::route('support.create') }}"><button class="btn btn-info btn-lg">Ouvrir un ticket</button></a>
                </div>
                        <h4 class="text-center">Le support ticket est en cours de construction.</h4>
                        <p style="text-align: center;">En cas de problème, veuillez utiliser le Forum pour nous contacter.</p>
                        <div id="status"></div>
                    @endif
                </div>
            </div>
