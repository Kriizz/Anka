                            ...
                            <div class="ak-item-elt-inner">
                                <div class="ak-item-elt-title">
                                    <a href="{{ URL::route('posts.show', [$post->id, $post->slug]) }}">
                                        <img src="{{ URL::asset($post->author) }}" alt="Admin" title="Auteur">
                                    </a>

                                <span class="ak-text">
                                    <a href="{{ URL::route('posts.show', [$post->id, $post->slug]) }}">{{ $post->title }}</a>
...
<div class="row ak-container">
    <div class="ak-column ak-container col-sm-4"><a class="ak-link-news" href="{{ route('posts.news') }}"> Toutes les news </a></div>
    <div class="ak-column ak-container col-sm-4"><a class="ak-link-calandar" href="{{ route('posts.type', 'infos') }}"> Toutes les infos </a></div>
    <div class="ak-column ak-container col-sm-4"><a class="ak-link-patch" href="{{ route('posts.type', 'patchs') }}"> Tous les patchs </a></div>
</div>
@stop
