                            ...
                            <div class="ak-links-block col-md-7">
                                <div class="ak-link-block col-sm-4">
                                    ...
                                    <div class="ak-bottom-link">
                                        <a class="btn btn-info btn-lg" href="forum.intel/22-tutorials/">voir les tutoriels</a>
                                    </div>
                                </div>
                                <div class="ak-link-block col-sm-4">
                                    <div class="ak-link-title">
                                    ...
                                    <div class="ak-bottom-link">
                                        <a class="btn btn-info btn-lg" href="https://forum.Intel.us" target="_blank">découvrir la communauté</a>
                                    </div>
                                </div>
                                <div class="ak-link-block col-sm-4">
                                    <div class="ak-link-title">
