...
<head>
	...
	<meta name="description" content="Intel Serveur" />
...
<body>
	<header role="header">
		<div>
			<a href="">
				<h1 id="logo" title="Intel Serveur" alt="Intel Serveur"></h1>
			</a>
			<nav role="navigation">
				<ul>
	...
	<section role="footer">
		...
		<footer>
			<p>
				...
				<br /> © 2015 <strong>Intel</strong>. Tous droits réservés. Design by <strong>Nicow</strong>. <a href="">Conditions d'utilisations</a> - <a href="">Conditions générales de vente</a>.
			</p>
		</footer>
	</section>
</body>
